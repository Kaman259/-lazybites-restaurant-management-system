...
class Settings(BaseSettings):
    ...
    def upload_path(
        ...
        """Return absolute upload directory."""
    ...
    @property
    def menu_upload_path(
        self,
    ) -> Path:
        """Return menu-item upload directory."""
    ...
    @property
    def restaurant_upload_path(
        self,
    ) -> Path:
        """Return restaurant upload directory."""
    ...
    @property
    def firebase_credentials_file(
        self,
    ) -> Path:
        """Return Firebase credential file path."""
